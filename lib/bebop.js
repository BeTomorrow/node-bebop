...
Bebop.prototype.connect = function(callback) {
  this.discover(function() {
    ...
    this._d2cServer.on("error", (error) => {
    ...
    this._checkLoop = setInterval(function() {
      if (Date.now() - this._lastPacketReceivedTime > 2000) {
        this.disconnect();
      }
    }.bind(this), 1000);
    ...
    var i = 0;
    this._pcmdLoop = setInterval(function() {
